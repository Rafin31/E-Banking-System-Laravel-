                            ...
                            <div class="card-body">
                                <div class="form-validation">
                                    ...
                                    <form class="form-valide"  method="post">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-meter">Customer Code<span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="number" class="form-control" id="val-nid" name="c_code"
                                                    placeholder="Enter Customer code">
                                                    <div class="div alert-danger">{{$errors->first('c_code')}}</div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <select class="form-control" id="val-skill" name="type">
                                                    ...
                                                    <option value="Titas Gas Postpaid">Titas Gas Postpaid</option>
                                                    <option value="Titas Gas Postpaid">Titas Gas Prepaid
                                                    </option>
                                                    <option value="Karnaphuli Gas">Karnaphuli Gas
                                                    </option>
                                                </select>
