...
@include('head.head' , ['title' => " Telephone "] )
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="val-meter">Enter phone
                                        Number<span class="text-danger">*</span>
                                    </label>
                                    <div class="col-lg-6">
                                        <input type="number" class="form-control" id="val-nid" name="p_num"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <select class="form-control" id="val-skill" name="type">
                                            ...
                                            <option value="BTCL">BTCL
                                            </option>
                                            <option value="Amber IT IP PHONE">Amber IT IP PHONE
                                            </option>
                                            <option value="BTCL Alaap">BTCL Alaap
                                            </option>
