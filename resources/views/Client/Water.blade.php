                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" action="#" method="post">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <label class="col-lg-4 col-form-label" for="val-phoneus">Bill Month
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="val-meter">Enter Bill
                                        Number<span class="text-danger">*</span>
                                    </label>
                                    <div class="col-lg-6">
                                        <input type="number" class="form-control" id="val-nid" name="b_num"
                                            placeholder="Enter Bill Number">
                                            <div class="div alert-danger">{{$errors->first('b_num')}}</div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <select class="form-control" id="val-skill" name="type">
                                            ...
                                            <option value="Dhaka WASA">Dhaka WASA
                                            </option>
                                            <option value="Rajsahi WASA">Rajsahi WASA
                                            </option>
                                            <option value="Khulna WASA">Khulna WASA
                                            </option>
                                            <option value="cHATTOGRAM WASA">Chattogram WASA
                                            </option>
                                        </select>
