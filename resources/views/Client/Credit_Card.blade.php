...
@include('head.head' , ['title' => " Credit Card "] )
                                ...
                                <div class="form-validation">
                                    <form class="form-valide" action="#" method="post">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-meter">Enter Credit Card
                                                Number<span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="number" class="form-control" id="val-nid" name="cr_number"
                                                    placeholder="Enter Credit Card Number">
                                                    <div class="div alert-danger">{{$errors->first('cr_number')}}</div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <select class="form-control" id="val-skill" name="type">
                                            ...
                                            <option value="Visa credit card">Visa credit card
                                            </option>
                                            <option value="City Bank Credit Card">City Bank Credit Card</option>
                                            </option>
